...
export function ClientAppShell({ products, settings }: { products: Product[]; settings?: Record<string, string> }) {
  ...
  const businessName = settings?.business_name || "LINOEM HOTEL";
          ...
          <section className="tab-view fade-in">
            ...
            <div className="promo-banner">
              <div className="promo-text">
                ...
                <h2>Hospedaje Premium & Confort Exclusivo</h2>
                <p>Reserva las habitaciones más exclusivas con disponibilidad en tiempo real.</p>
              </div>
            </div>
        ...
        {activeTab === "rastrear" && (
          <section className="tab-view center-view fade-in">
            ...
            <div className="ios-widget">
              ...
              <p>Monitorea tu estancia, solicita consumos adicionales y chatea con recepción en tiempo real.</p>
              
              <form action="/api/customer/access" method="post" className="ios-form">
                <div className="ios-input-group">
                  <label htmlFor="code">Ingresa tu Folio Privado</label>
                  <input 
                    id="code"
                    name="code" 
          ...
          <section className="tab-view fade-in">
            ...
            <div className="support-cards-grid">
              <div className="ios-info-card">
                ...
                <h3>Servicios de Estancia</h3>
                <p>Nuestras habitaciones cuentan con todas las comodidades y atención personalizada las 24 horas para tu total tranquilidad.</p>
