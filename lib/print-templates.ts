    ...
    <html>
      ...
      <body>
        ...
        <div class="content-wrap">
          ...
          <div class="footer">
            <p>¡Gracias por su preferencia!<br>Conserve este ticket para devoluciones o facturas.<br>LINOEM Hotel desea que haya disfrutado su estancia.</p>
    ...
    <html>
      ...
      <body>
        ...
        <div class="page-content">
          <div class="top-bar">
            <span>Estado de Cuenta de Hospedaje LINOEM Hotel</span>
            <span>${type === "client" ? "Copia Huésped" : "Copia Propietario / Oficina"}</span>
          </div>
          ...
          <div class="client-box">
            <div style="font-size: 13px; font-weight: bold; color: #1e3a60; border-bottom: 2px solid #0054a6; padding-bottom: 4px; margin-bottom: 8px;">
              DATOS DE ESTANCIA / HUÉSPED
            </div>
            <strong>HUÉSPED REGISTRADO</strong><br>
            RFC: XAXX010101000<br>
            Dirección: Hotel Juárez Matriz<br>
            Ciudad Juárez, Chihuahua, México<br>
            Recepcionista: ${seller}
          </div>
          ...
          <table class="detail-table">
            <thead>
              <tr>
                ...
                <th>Descripción del Concepto / Consumo</th>
